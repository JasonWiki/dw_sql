drop table if exists dw_db_temp.dw_app_action_daily_summary_hzq_tmp;
create table dw_db_temp.dw_app_action_daily_summary_hzq_tmp as
select
name as app_name,
dvid,
...
insert overwrite table dw_db.dw_app_action_daily_summary partition (p_dt=${dealDate})
select *
from (
  ...
  inner join dw_db_temp.dw_app_action_daily_summary_hzq_tmp b
  on a.name=b.app_name
  and a.dvid=b.dvid
  and a.p_dt=${dealDate}
  group by a.name,a.action_id,a.action_name
