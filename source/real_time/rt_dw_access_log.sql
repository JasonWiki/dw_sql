-- 外部表
CREATE EXTERNAL TABLE IF NOT EXISTS real_time.rt_dw_access_log (
...
-- 分区加载外部数据
ALTER TABLE real_time.rt_dw_access_log ADD IF NOT EXISTS PARTITION  (p_dt = ${dealDate}) LOCATION '/flume/dw_access_log/dw_access_log_${baseDealDate}';
